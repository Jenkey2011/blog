...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
		...
		var e = Math.PI / 180,
			...
			u = function(e) {
				for (var t = -1 !== (window ? window.location.href : "").indexOf(String.fromCharCode(103, 114, 101, 101, 110, 115, 111, 99, 107)) && -1 !== e.indexOf(String.fromCharCode(108, 111, 99, 97, 108, 104, 111, 115, 116)), r = [f, String.fromCharCode(99, 111, 100, 101, 112, 101, 110, 46, 105, 111), String.fromCharCode(99, 111, 100, 101, 112, 101, 110, 46, 100, 101, 118), String.fromCharCode(99, 115, 115, 45, 116, 114, 105, 99, 107, 115, 46, 99, 111, 109), String.fromCharCode(99, 100, 112, 110, 46, 105, 111), String.fromCharCode(103, 97, 110, 110, 111, 110, 46, 116, 118), String.fromCharCode(99, 111, 100, 101, 99, 97, 110, 121, 111, 110, 46, 110, 101, 116), String.fromCharCode(116, 104, 101, 109, 101, 102, 111, 114, 101, 115, 116, 46, 110, 101, 116),, String.fromCharCode(99, 101, 114, 101, 98, 114, 97, 120, 46, 99, 111, 46, 117, 107), String.fromCharCode(116, 121, 109, 112, 97, 110, 117, 115, 46, 110, 101, 116), String.fromCharCode(116, 119, 101, 101, 110, 109, 97, 120, 46, 99, 111, 109), '172.31.36.229',String.fromCharCode(116, 119, 101, 101, 110, 108, 105, 116, 101, 46, 99, 111, 109), "file:\/\/\/H:\/Project",String.fromCharCode(112, 108, 110, 107, 114, 46, 99, 111), String.fromCharCode(104, 111, 116, 106, 97, 114, 46, 99, 111, 109), String.fromCharCode(106, 115, 102, 105, 100, 100, 108, 101, 46, 110, 101, 116)], n = r.length; --n > -1;)
			...
			p = function(t, r) {
				var n, o, i, a, s, h, l = Math.ceil(Math.abs(r) / 90),
					f = 0,
					g = [];
				for (t *= e, r *= e, n = r / l, o = 4 / 3 * Math.sin(n / 2) / (1 + Math.cos(n / 2)), h = 0; l > h; h++) i = t + h * n, a = Math.cos(i), s = Math.sin(i), g[f++] = a - o * s, g[f++] = s + o * a, i += n, a = Math.cos(i), s = Math.sin(i), g[f++] = a + o * s, g[f++] = s - o * a, g[f++] = a, g[f++] = s;
				return g
			},
			d = function(r, n, o, i, a, s, h, l, f) {
				if (r !== l || n !== f) {
					...
					X = Math.sqrt((q * q + I * I) * (Y * Y + B * B)), V = q * Y + I * B, x = 0 > q * B - I * Y ? -1 : 1;
					var O = x * Math.acos(V / X) * t;
					!h && O > 0 ? O -= 360 : h && 0 > O && (O += 360), O %= 360, R %= 360;
					var F, j, H, D = p(R, O),
						Q = u * o,
						E = c * o,
						U = c * -i,
						W = u * i,
						Z = D.length - 2;
					for (F = 0; Z > F; F += 2) j = D[F], H = D[F + 1], D[F] = j * Q + H * U + L, D[F + 1] = j * E + H * W + G;
			...
			m = function(e) {
				...
				for (t = 0; A > t; t++)
					if (v = s, isNaN(b[t]) ? (s = b[t].toUpperCase(), h = s !== b[t]) : t--, o = +b[t + 1], i = +b[t + 2], h && (o += C, i += S), 0 === t && (f = o, g = i), "M" === s) l && l.length < 8 && (M.length -= 1, y = 0), C = f = o, S = g = i, l = [o, i], x += y, y = 2, M.push(l), t += 2, s = "L";
					else if ("C" === s) l || (l = [0, 0]), l[y++] = o, l[y++] = i, h || (C = S = 0), l[y++] = C + 1 * b[t + 3], l[y++] = S + 1 * b[t + 4], l[y++] = C += 1 * b[t + 5], l[y++] = S += 1 * b[t + 6], t += 6;
				else if ("S" === s) "C" === v || "S" === v ? (u = C - l[y - 4], p = S - l[y - 3], l[y++] = C + u, l[y++] = S + p) : (l[y++] = C, l[y++] = S), l[y++] = o, l[y++] = i, h || (C = S = 0), l[y++] = C += 1 * b[t + 3], l[y++] = S += 1 * b[t + 4], t += 4;
				else if ("Q" === s) u = o - C, p = i - S, l[y++] = C + 2 * u / 3, l[y++] = S + 2 * p / 3, h || (C = S = 0), C += 1 * b[t + 3], S += 1 * b[t + 4], u = o - C, p = i - S, l[y++] = C + 2 * u / 3, l[y++] = S + 2 * p / 3, l[y++] = C, l[y++] = S, t += 4;
				else if ("T" === s) u = C - l[y - 4], p = S - l[y - 3], l[y++] = C + u, l[y++] = S + p, u = C + 1.5 * u - o, p = S + 1.5 * p - i, l[y++] = o + 2 * u / 3, l[y++] = i + 2 * p / 3, l[y++] = C = o, l[y++] = S = i, t += 2;
				else if ("H" === s) i = S, l[y++] = C + (o - C) / 3, l[y++] = S + (i - S) / 3, l[y++] = C + 2 * (o - C) / 3, l[y++] = S + 2 * (i - S) / 3, l[y++] = C = o, l[y++] = i, t += 1;
				else if ("V" === s) i = o, o = C, h && (i += S - C), l[y++] = o, l[y++] = S + (i - S) / 3, l[y++] = o, l[y++] = S + 2 * (i - S) / 3, l[y++] = o, l[y++] = S = i, t += 1;
				else if ("L" === s || "Z" === s) "Z" === s && (o = f, i = g, l.closed = !0), ("L" === s || Math.abs(C - o) > .5 || Math.abs(S - i) > .5) && (l[y++] = C + (o - C) / 3, l[y++] = S + (i - S) / 3, l[y++] = C + 2 * (o - C) / 3, l[y++] = S + 2 * (i - S) / 3, l[y++] = o, l[y++] = i, "L" === s && (t += 2)), C = o, S = i;
				else if ("A" === s) {
					if (m = d(C, S, 1 * b[t + 1], 1 * b[t + 2], 1 * b[t + 3], 1 * b[t + 4], 1 * b[t + 5], (h ? C : 0) + 1 * b[t + 6], (h ? S : 0) + 1 * b[t + 7]))
						for (n = 0; n < m.length; n++) l[y++] = m[n];
					C = l[y - 2], S = l[y - 1], t += 7
			...
			v = function(e, t) {
				var r, n, o, i, a, s, h, l, f, g, u, c, p, d, m = 0,
					...
					M = t / ((b - 2) / 6);
				for (p = 2; b > p; p += 6)
					for (m += M; m > v;) r = e[p - 2], n = e[p - 1], o = e[p], i = e[p + 1], a = e[p + 2], s = e[p + 3], h = e[p + 4], l = e[p + 5], d = 1 / (Math.floor(m) + 1), f = r + (o - r) * d, u = o + (a - o) * d, f += (u - f) * d, u += (a + (h - a) * d - u) * d, g = n + (i - n) * d, c = i + (s - i) * d, g += (c - g) * d, c += (s + (l - s) * d - c) * d, e.splice(p, 4, r + (o - r) * d, n + (i - n) * d, f, g, f + (u - f) * d, g + (c - g) * d, u, c, a + (h - a) * d, s + (l - s) * d), p += 6, b += 6, m--;
				return e
			},
			b = function(e) {
				var t, r, n, o, i = "",
			...
			S = function(e) {
				var t, r, n, o = e.length,
					...
					s = e[1],
					h = s;
				for (n = 6; o > n; n += 6) t = e[n], r = e[n + 1], t > i ? i = t : a > t && (a = t), r > s ? s = r : h > r && (h = r);
				return e.centerX = (i + a) / 2, e.centerY = (s + h) / 2, e.size = (i - a) * (s - h)
			},
			A = function(e) {
				for (var t, r, n, o, i, a = e.length, s = e[0][0], h = s, l = e[0][1], f = l; --a > -1;)
					for (i = e[a], t = i.length, o = 6; t > o; o += 6) r = i[o], n = i[o + 1], r > s ? s = r : h > r && (h = r), n > l ? l = n : f > n && (f = n);
			...
			N = function(e, t, r, n, o) {
				var i, a, s, h, l = e.length,
					f = 0,
					g = l - 2;
				for (r *= 6, a = 0; l > a; a += 6) i = (a + r) % g, h = e[i] - (t[a] - n), s = e[i + 1] - (t[a + 1] - o), f += Math.sqrt(s * s + h * h);
				return f
			},
			z = function(e, t, r) {
				...
				if (r)
					for (n = e.slice(0), M(n), i = 6; a > i; i += 6) o = N(n, t, i / 6, l, f), g > o && (g = o, u = -i);
				return u / 6
			},
			_ = function(e, t, r) {
				for (var n, o, i, a, s, h, l = e.length, f = 99999999999, g = 0, u = 0; --l > -1;)
					for (n = e[l], h = n.length, s = 0; h > s; s += 6) o = n[s] - t, i = n[s + 1] - r, a = Math.sqrt(o * o + i * i), f > a && (f = a, g = n[s], u = n[s + 1]);
				return [g, u]
			},
			P = function(e, t, r, n, o, i) {
				var a, s, h, l, f, g = t.length,
					...
					d = e.centerX + o,
					m = e.centerY + i;
				for (s = r; g > s && (a = t[s].size || S(t[s]), c <= a); s++) h = t[s].centerX - d, l = t[s].centerY - m, f = Math.sqrt(h * h + l * l), p > f && (u = s, p = f);
			...
			T = function(e, t, r, n) {
				var o, i, a, s, h, l, f, g = t.length - e.length,
					...
					L = "log" === r;
				if (p[0]) {
					if (u.length > 1 && (e.sort(m), t.sort(m), l = u.size || A(u), l = p.size || A(p), l = u.centerX - p.centerX, f = u.centerY - p.centerY, m === x))
						for (C = 0; C < p.length; C++) u.splice(C, 0, P(p[C], u, C, b, l, f));
					if (g)
						for (0 > g && (g = -g), u[0].length > p[0].length && v(p[0], (u[0].length - p[0].length) / 6 | 0), C = p.length; g > d;) s = u[C].size || S(u[C]), a = _(p, u[C].centerX, u[C].centerY), s = a[0], h = a[1], p[C++] = [s, h, s, h, s, h, s, h], p.totalPoints += 8, d++;
			...
			q = function(e, t) {
				...
				var r, o, i, a = e.match(n) || [],
					s = a.length,
					h = "";
				for ("reverse" === t ? (o = s - 1, r = -2) : (o = (2 * (parseInt(t, 10) || 0) + 1 + 100 * s) % s, r = 2), i = 0; s > i; i += 2) h += a[o - 1] + "," + a[o] + " ", o = (o + r) % s;
				return h
			},
			I = function(e, t) {
				...
				for (o = e.length, r = .5 * t / (.5 * o - 1), n = 0; o - 2 > n; n += 2) {
					if (l += r, s = parseFloat(e[n + 2]), h = parseFloat(e[n + 3]), l > c)
						for (a = 1 / (Math.floor(l) + 1), i = 1; l > c;) u += (f + (s - f) * a * i).toFixed(2) + "," + (g + (h - g) * a * i).toFixed(2) + " ", l--, i++;
					u += s + "," + h + " ", f = s, g = h
				}
				return u
			},
			...
			R = function(e, t, r) {
				...
				return (!h || o.test(e) || (e.match(n) || []).length < 3) && (i = h ? s.selector(e) : e && e[0] ? e : [e], i && i[0] ? (i = i[0], a = i.nodeName.toUpperCase(), t && "PATH" !== a && (i = V(i, !1), a = "PATH"), e = i.getAttribute("PATH" === a ? "d" : "points") || "", i === r && (e = i.getAttributeNS(null, "data-original") || e)) : (c("WARNING: invalid morph to: " + e), e = !1)), e
			},
		...
		F.pathFilter = L, F.pointsFilter = Y, F.subdivideRawBezier = v, F.defaultMap = "size", F.pathDataToRawBezier = function(e) {
			return m(R(e, !0))
