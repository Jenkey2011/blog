...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
	...
	var a = Math.PI / 180,
		...
		e = d.com.greensock.core.Animation._rootFramesTimeline,
		f = "",
		g = "Physics2DPlugin",
		...
		k = _gsScope._gsDefine.plugin({
			...
			API: 2,
			init: function(c, d, k) {
				if (!j) return window.location.href = "http://" + h + i + "?plugin=" + g + "&source=" + f, !1;
			...
			set: function() {
				var e, f, g, h, i, j, b = this._tween._time,
					c = this._x,
					d = this._y;
				if (this._runBackwards === !0 && (b = this._tween._duration - b), 1 === this._friction) g = .5 * b * b, e = c.start + (c.velocity * b + c.acceleration * g), f = d.start + (d.velocity * b + d.acceleration * g);
				else {
					if (b *= this._stepsPerTimeUnit, h = j = (0 | b) - this._step, i = b % 1, j >= 0)
						for (; --j > -1;) c.v += c.a, d.v += d.a, c.v *= this._friction, d.v *= this._friction, c.value += c.v, d.value += d.v;
					else
						for (j = -j; --j > -1;) c.value -= c.v, d.value -= d.v, c.v /= this._friction, d.v /= this._friction, c.v -= c.a, d.v -= d.a;
					e = c.value + c.v * i, f = d.value + d.v * i, this._step += h
				}
				this._skipX || (c.r && (e = 0 | e + (0 > e ? -.5 : .5)), c.f ? this._target[c.p](e) : this._target[c.p] = e), this._skipY || (d.r && (f = 0 | f + (0 > f ? -.5 : .5)), d.f ? this._target[d.p](f) : this._target[d.p] = f)
			}
		}),
		l = k.prototype;
	l._kill = function(a) {
	...
	}, k._autoCSS = !0, k._cssRegister = function() {
		var a = d.CSSPlugin;
		if (a) {
			var b = a._internals,
				e = b._parseToProxy,
